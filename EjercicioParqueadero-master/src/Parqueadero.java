...
// -----------------------------------------------------------------
    ...
    /* TALLER GRUPO WILIAM RAMIREZ, MATEO RAMIREZ*/
    ...
    public void hayCarroMasDeOchoHoras() {
        int puestoMasHoras = -1;
        int maxHoras = 0;
        ...
        if (puestoMasHoras != -1) {
            System.out.println("* El carro con más de 8 horas se encuentra en el puesto: " + puestoMasHoras);
        } else {
            System.out.println("* No hay ningún carro estacionado mas de ocho horas en el parqueadero.");
        }
    }

    public ArrayList<Carro> darCarrosMasDetresHorasParqueadas() {
    ...
    public boolean hayCarrosPlacaIgual() {
        for (int i = 0; i < TAMANO - 1; i++) {
            if (estaOcupado(i)) {
                String placa1 = puestos[i].darCarro().darPlaca();
    ...
    public String metodo1() {
        String respuesta1 = ("* Cantidad de carros con placa PB: " + contarCarrosQueComienzanConPlacaPB() +
                        " * Hay carro parqueado por 24 o mas horas: "+ hayCarroCon24Horas());
        return respuesta1;
    }
    ...
    {
        String respuesta2 = ("Cantidad de carros sacados: " + desocuparParqueadero());
        return respuesta2;
    }
